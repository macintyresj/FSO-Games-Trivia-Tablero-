const questions = {
  ACRONIMOS: [
    {question: "IRS refers to?", options: ["Income Return System", "Internal Revenue Service", "Internal Review System"], answer: "Internal Revenue Service", points: 10000},
    {question: "What does BTC mean in tax context?", options: [ "Bank Tax Credit", "Basic Tax Calculation", "Business Tax Compliance", "Business Trust Corporation"], answer: "Business Tax Compliance", points: 25000},
    {question: "FSO refers to?", options: [ "Federal Securities Organization", "Finance and Strategy Office", "Foreign Service Operations", "Financial Service Office"], answer: "Financial Service Office", points: 15000},
    ...
    {question: "CR stands for in GDS?", options: [ "Capital Reporting", "Compliance Review", "Cash Reconciliation", "Corporate Responsibility"], answer: "Corporate Responsibility", points: 25000},
    ...
    {question: "EBII stands for?", options: ["Estimated Business Investment Income","Excess Business Interest Income",  "Excess Bonus Investment Interest", "Effective Business Income Increment"], answer: "Excess Business Interest Income", points: 25000},
    {question: "EBIE stands for?", options: [ "Estimated Bonus Interest Expense", "Excess Book Interest Expense","Excess Business Interest Expense", "Effective Business Investment Expense"], answer: "Excess Business Interest Expense", points: 25000},
    {question: "ATI refers to?", options: ["Annual Taxable Investment", "Accounting Taxable Income", "Adjusted Taxable Income", "Accumulated Taxable Income"], answer: "Adjusted Taxable Income", points: 35000},
    {question: "UBTI means?", options: [ "Universal Business Taxable Investment", "Undistributed Business Taxable Income", "United Business Tax Indicator"], answer: "Unrelated Business Taxable Income", points: 10000},
    {question: "PTIN stands for?", options: ["Preparer Tax Identification Number", "Professional Tax Identification Number", "Primary Taxpayer Identification Number", "Unrelated Business Taxable Income", "Partnership Tax Identification Number"], answer: "Preparer Tax Identification Number", points: 15000},
    {question: "EIN stands for?", options: [ "Employee Identification Number", "Employer Identification Number","Entity Identification Number", "Enterprise Internal Number"], answer: "Employer Identification Number", points: 15000},
    {question: "SSN refers to?", options: ["Standard Service Number", "Social Savings Number","Social Security Number",  "State Security Number"], answer: "Social Security Number", points: 15000},
    ...
    {question: "AFS refers to?", options: [ "Accounting Financial Summary", "Annual Fiscal Statement", "Adjusted Financial Schedule", "Audited Financial Statement",], answer: "Audited Financial Statement", points: 10000},
    ...
    {question: "BCP stands for?", options: [ "Business change Process", "Business comunication Plan", "Business continuity Plan", "Business continuity Protocol"], answer: "Business continuity Plan", points: 50000},
    {question: "what is FDAP?", options: [ "Foreign Derived Annual Profit", "Fixed, Determinable, Annual or Periodical Income", "Federal Deductible Adjusted Payment", "Final Deferred Asset Profit"], answer: "Fixed, Determinable, Annual or Periodical Income", points: 15000}
  ],
  TAX: [
    ...
    {question: "What is the general due date to file Form 1065?", options: ["January 31", "March 15", "April 15", "May 15"], answer: "March 15", points: 15000},
    {question: "What is the main difference between ECI and FDAP?", options: ["ECI applies only to individuals, FDAP only to corporations","ECI is connected with a US trade or business, FDAP is not", "ECI is taxed at a flat rate, FDAP is progressive", "ECI is exempt income, FDAP is deductible"], answer: "ECI is connected with a US trade or business, FDAP is not", points: 35000},
    {question: "Which form is filed to claim the Foreign Tax Credit?", options: [ "Form 2555", "Form 8621", "Form 1116","Form 8886"], answer: "Form 1116", points: 35000},
    {question: "What information is detailed in Section L of the K-1?", options: ["Capital account analysis", "Income distribution summary", "Partner’s address", "Passthrough credits"], answer: "Capital account analysis", points: 35000},
    {question: "What does the True-Up file represent?", options: ["The reconciliation between draft and final versions", "A preliminary estimate of tax", "The support file for estimates", "The annual federal summary"], answer: "The reconciliation between draft and final versions", points: 35000},
    {question: "What is the main purpose of Form 8886?", options: ["To claim investment credits", "To report foreign source income","To disclose reportable transactions", "To request tax refunds"], answer: "To disclose reportable transactions", points: 35000},
    ...
    {question: "In which cases must a K-3 be attached to a K-1?", options: ["When there are foreign income or credit items", "Only if there is more than one foreign partner", "When the entity is registered outside the US", ], answer: "When there are foreign income or credit items", points: 50000},
  ...
  "Música": [
    // 10k
    {question: "¿Quién es el cantante principal de Coldplay?", options: ["Bono", "Adam Levine", "Chris Martin", "Bruno Mars"], answer: "Chris Martin", points: 10000},
    {question: "¿Qué artista lanzó el álbum '30' en 2021?", options: ["Taylor Swift", "Adele", "Beyoncé", "Billie Eilish"], answer: "Adele", points: 10000},
    {question: "¿Qué cantante lanzó el éxito 'As It Was' en 2022?", options: [ "Ed Sheeran", "Justin Bieber", "Harry Styles", "Shawn Mendes"], answer: "Harry Styles", points: 10000},

    // 15k
    {question: "¿Quién ganó el MTV Video Music Award al Video del Año en 2022?", options: ["Beyoncé", "Taylor Swift","Lil Nas X",  "Doja Cat"], answer: "Lil Nas X", points: 15000},
    {question: "¿Qué grupo de K-pop es conocido por éxitos como 'Dynamite' y 'Butter'?", options: ["EXO", "BTS","BLACKPINK",  "TWICE"], answer: "BTS", points: 15000},
    ...
    // 25k
    {question: "¿Qué cantante encabezó el espectáculo de medio tiempo del Super Bowl en 2023?", options: ["Shakira", "Rihanna", "Beyoncé", "Taylor Swift"], answer: "Rihanna", points: 25000},
    {question: "¿Qué banda lanzó el álbum 'Music of the Spheres'?", options: ["Imagine Dragons", "Maroon 5", "OneRepublic", "Coldplay"], answer: "Coldplay", points: 25000},
    {question: "¿Quién ganó el Grammy al Álbum del Año en 2023?", options: ["Beyoncé", "Harry Styles", "Taylor Swift", "Bruno Mars"], answer: "Harry Styles", points: 25000},

    // 35k
    {question: "¿Qué artista es conocido por la canción 'Levitating'?", options: ["Ariana Grande", "Lady Gaga", "Dua Lipa", "Billie Eilish"], answer: "Dua Lipa", points: 35000},
    {question: "¿Qué artista lanzó el álbum 'Midnights' en 2022?", options: ["Adele", "Olivia Rodrigo", "Taylor Swift", "Billie Eilish"], answer: "Taylor Swift", points: 35000},
    {question: "¿Quién es el cantante principal de Imagine Dragons?", options: [ "Adam Levine", "Dan Reynolds", "Brandon Flowers", "Chris Martin"], answer: "Dan Reynolds", points: 35000},

    // 50k
    {question: "¿Qué rapero lanzó 'Mr. Morale & The Big Steppers' en 2022?", options: [ "Drake", "J. Cole", "Travis Scott", "Kendrick Lamar"], answer: "Kendrick Lamar", points: 50000},
    {question: "¿Qué artista ganó Billboard Artista del Año 2022?", options: [ "Taylor Swift", "Drake", "Bad Bunny", "Beyoncé"], answer: "Bad Bunny", points: 50000},
    {question: "¿Qué cantante es conocida por la canción 'Flowers' lanzada en 2023?", options: [ "Dua Lipa", "Miley Cyrus", "Selena Gomez", "Adele"], answer: "Miley Cyrus", points: 50000}
  ],
  ...
  "Cine y Series": [
    ...
    {question: "¿Quién interpreta a Eleven en la serie 'Stranger Things'?", options: [ "Sadie Sink", "Natalia Dyer", "Millie Bobby Brown", "Maya Hawke"], answer: "Millie Bobby Brown", points: 10000},
    {question: "¿Qué director es conocido por la trilogía 'The Dark Knight'?", options: [ "Steven Spielberg", "Christopher Nolan", "James Cameron", "Quentin Tarantino"], answer: "Christopher Nolan", points: 10000},

    // 15k
    {question: "En 'Game of Thrones', ¿quién se sienta en el Trono de Hierro al final?", options: ["Daenerys Targaryen", "Bran Stark", "Jon Snow", "Sansa Stark"], answer: "Bran Stark", points: 15000},
    {question: "¿Qué película incluye la canción 'Let It Go'?", options: ["Moana", "Enredados", "Coco", "Frozen"], answer: "Frozen", points: 15000},
    {question: "¿Quién dirigió la película 'Avatar: The Way of Water'?", options: [ "Peter Jackson", "Ridley Scott", "Steven Spielberg", "James Cameron",], answer: "James Cameron", points: 15000},

    // 25k
    {question: "¿Qué actor interpreta a Doctor Strange en el Universo Cinematográfico de Marvel?", options: [ "Robert Downey Jr.","Benedict Cumberbatch", "Chris Hemsworth", "Tom Holland"], answer: "Benedict Cumberbatch", points: 25000},
    {question: "¿Qué serie tiene a los personajes Eleven, Mike, Dustin y Lucas?", options: [ "The Umbrella Academy", "The Witcher","Stranger Things","Locke & Key"], answer: "Stranger Things", points: 25000},
    ...
    // 35k
    {question: "¿Qué actriz interpreta a la Princesa Leia en Star Wars?", options: [ "Natalie Portman", "Daisy Ridley", "Felicity Jones", "Carrie Fisher",], answer: "Carrie Fisher", points: 35000},
    {question: "¿En qué año se estrenó la primera película de Harry Potter?", options: [ "1999","2000", "2001", "2002"], answer: "2001", points: 35000},
    {question: "¿Quién dirigió 'Everything Everywhere All At Once'?", options: [ "Wes Anderson", "Spike Lee", "Dan Kwan y Daniel Scheinert", "Greta Gerwig"], answer: "Dan Kwan y Daniel Scheinert", points: 35000},
    ...
    {question: "¿Qué película animada ganó el Oscar a Mejor Película Animada en 2023?", options: ["Puss in Boots: The Last Wish", "Mundos Extraños", "Pinocho de Guillermo del Toro",  "Minions: El Ascenso de Gru"], answer: "Pinocho de Guillermo del Toro", points: 50000}
  ],

  "Cultura Pop": [
    // 10k
    {question: "¿Qué red social es conocida por videos cortos y tendencias?", options: ["Instagram", "Snapchat", "TikTok", "Twitter"], answer: "TikTok", points: 10000},
    {question: "¿Qué serie popular tiene a Ted, Barney y Robin?", options: ["Friends", "The Big Bang Theory", "How I met your mother", "Modern Family"], answer: "How I met your mother", points: 10000},
    {question: "¿Cuál de estos personajes NO pertenece a DC", options: [ "Batman", "Wonder Woman", "Black Widow", "Flash"], answer: "Black Widow", points: 10000},

    // 15k
    {question: "¿Qué cantante es conocida como la 'Reina del Pop'?", options: ["Beyoncé", "Madonna",  "Lady Gaga", "Britney Spears"], answer: "Madonna", points: 15000},
    {question: "¿Quién es la fundadora del Met Gala?", options: ["Vogue", "Rihanna", "Anna Wintour", "Karl Lagerfeld"], answer: "Anna Wintour", points: 15000},
    ...
    // 25k
    {question: "¿Qué marca de moda es conocida por su logo con dos G entrelazadas?", options: ["Chanel", "Prada", "Gucci", "Louis Vuitton"], answer: "Gucci", points: 25000},
    {question: "¿Qué artista pintó 'Girl with Balloon'?", options: ["Van Gogh", "Picasso", "Banksy", "Andy Warhol"], answer: "Banksy", points: 25000},
    ...
    // 35k
    {question: "¿Qué reality show es famoso por la frase 'You’re fired'?", options: ["Survivor", "The Apprentice", "Big Brother", "MasterChef"], answer: "The Apprentice", points: 35000},
    {question: "¿En qué año se estrenó la primera película de 'Jurassic Park'?", options: [ "1985", "1990", "1993", "1999"], answer: "1993", points: 35000},
    {question: "¿Qué actor interpreta al Joker en la película de 2019?", options: [ "Heath Ledger", "Jared Leto", "Jack Nicholson", "Joaquin Phoenix"], answer: "Joaquin Phoenix", points: 35000},

    // 50k
    {question: "¿Cómo se llama la nave piloteada por Han Solo?", options: ["X-Wing", "Millenial Falcon", "Y-Wing", "Tie Fighter"], answer: "Millenial Falcon", points: 50000},
    {question: "¿Quién es el creador de la seri 'Dragon Ball'?", options: [ "Eiichiro Oda", "Akira Toriyama","Masashi Kishimoto", "Takehiko Inoue"], answer: "Bad Bunny", points: 50000},
    {question: "¿Quién es el creador de la serie de cómics 'The Walking dead'?", options: ["Stan Lee", "Robert Kirkman", "Neil Gaiman", "Frank Miller"], answer: "Robert Kirkman", points: 50000}
  ],
